...
export class MyMigrations1659377875558 implements MigrationInterface {
    name = 'MyMigrations1659377875558'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "track" ADD CONSTRAINT "FK_c6b015f028051f496021441aa33" FOREIGN KEY ("favoritesId") REFERENCES "favorites"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
